...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    label: '桌面小宠物',
    emoji: '🐾',
    queries: ['desktop pet python', 'desktop mascot electron', 'virtual pet app', 'interactive desktop companion'],
    description: '萌萌的桌面小宠物和虚拟伴侣，让你的电脑屏幕充满生命力',
    hasCurated: true,
  },
  {
    id: 'ai-game',
    label: 'AI 趣味游戏',
    emoji: '🎮',
    queries: ['claude code game', 'vibe coding game browser', 'ai browser game', 'llm interactive game'],
    description: '用 AI 工具做的趣味小游戏，好玩又有创意',
    hasCurated: true,
  },
  {
    ...
    label: '创意生成器',
    emoji: '✨',
    queries: ['ai art generator web app', 'ai music generator', 'ai meme generator', 'ai story generator'],
    description: 'AI 驱动的艺术、音乐、表情包等创意生成工具',
    hasCurated: true,
  },
  {
    id: 'fun-tool',
    label: '整活工具',
    emoji: '😂',
    queries: ['ai funny tool', 'ai face swap web', 'ai voice changer app', 'ai roast bot'],
    description: '用 AI 整活的奇葩创意工具，刷新你对 AI 的想象',
    hasCurated: true,
  },
  {
    id: 'trending',
